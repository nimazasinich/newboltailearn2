...
export class MonitoringController {
    ...
    async getSystemMetrics(req, res) {
        try {
            ...
            // Get training status
            const trainingModels = this.db.prepare("SELECT COUNT(*) as count FROM models WHERE status = 'training'").get();
            const totalModels = this.db.prepare('SELECT COUNT(*) as count FROM models').get();
            const completedModels = this.db.prepare("SELECT COUNT(*) as count FROM models WHERE status = 'completed'").get();
            res.json({
                ...metrics,
                training: {
