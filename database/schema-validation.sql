-- Persian Legal AI Database Schema Validation
...
-- Document categories with hierarchical structure
CREATE TABLE IF NOT EXISTS categories (
    id TEXT PRIMARY KEY,
    name TEXT NOT NULL,
    name_en TEXT, -- English name for internationalization
    description TEXT,
    description_en TEXT,
    parent_id TEXT,
...
-- Persian legal documents with comprehensive metadata
...
-- AI Models with comprehensive tracking
...
CREATE TABLE IF NOT EXISTS predictions (
    ...
    all_predictions TEXT, -- JSON array of all category predictions
