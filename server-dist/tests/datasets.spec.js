...
describe('Datasets API', () => {
    ...
    it('should return datasets list', async () => {
        ...
        const iranLegalQa = response.body.find((d) => d.id === 'iran-legal-qa');
    ...
    it('should handle dataset download with valid token', async () => {
        ...
        const dataset = db.prepare('SELECT * FROM datasets WHERE id = ?').get('iran-legal-qa');
...
//# sourceMappingURL=datasets.spec.js.map