...
export class TrainingEngine {
    ...
    createMockPersianBERT(config) {
        ...
        model.name = 'persian_bert';
        return model;
    }
    createMockDoRAAdapter(config) {
        const model = tf.sequential({
            layers: [
                tf.layers.embedding({
                    inputDim: config.vocabSize,
        ...
        model.name = 'dora_model';
        return model;
    }
    createMockQRAdaptor(config) {
        const model = tf.sequential({
            layers: [
                tf.layers.embedding({
                    inputDim: config.vocabSize,
        ...
        model.name = 'qr_adaptor_model';
        return model;
    }
    async loadRealPersianBERT(config) {
    ...
    async loadRealDoRAAdapter(config) {
    ...
    async loadRealQRAdaptor(config) {
    ...
    async saveModel(checkpointPath) {
        if (!this.model) {
            throw new Error('No model initialized. Call initializeModel first.');
        }
    ...
    async saveRealModel(checkpointPath) {
    ...
    generateMockTrainingData(config) {
...
//# sourceMappingURL=TrainingEngine.js.map